...
pickled_name = '../data/pickled/' + os.path.basename('../data/events.csv') + 'with.app.pkl'

if os.path.isfile(pickled_name):
    events = pd.read_pickle(pickled_name)
else:
