...
def read_train_test():
    # Events
    if os.path.isfile('../data/pickled/events.pkl'):
        print('Load events')
        events_small = pd.read_pickle('../data/pickled/events.pkl')
    else:
        print('Read events...')
        events = pd.read_csv("../data/events.csv", dtype={'device_id': np.str})
        events['counts'] = events.groupby(['device_id'])['event_id'].transform('count')
        events_small = events[['device_id', 'counts']].drop_duplicates('device_id', keep='first')
        events_small.to_pickle('../data/pickled/events.pkl')

    # Phone brand
    if os.path.isfile('../data/pickled/brands.pkl'):
        print('Load brands')
        pbd = pd.read_pickle('../data/pickled/brands.pkl')
    else:
        print('Read brands...')
        ...
        pbd.to_pickle('../data/pickled/brands.pkl')

    # Train
    if os.path.isfile('../data/pickled/train.pkl'):
        print('Load Train')
        train = pd.read_pickle('../data/pickled/train.pkl')
    else:
        print('Read train...')
        ...
        train.to_pickle('../data/pickled/train.pkl')

    # Test
    if os.path.isfile('../data/pickled/test.pkl'):
        print('Load Test')
        test = pd.read_pickle('../data/pickled/test.pkl')
    else:
        print('Read test...')
        ...
        test.to_pickle('../data/pickled/test.pkl')
